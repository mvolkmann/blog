...
The Swift Standard Library defines the {% aTargetBlank
"https://developer.apple.com/documentation/swift/asyncstream",
"AsyncStream" %} `struct` which supports asynchronous sequences
that are generated by a closure that produces new elements.

The Swift Standard Library also defines the {% aTargetBlank
"https://developer.apple.com/documentation/swift/clock", "Clock" %} protocol
and the conforming structs {% aTargetBlank
"https://developer.apple.com/documentation/swift/continuousclock",
"ContinuousClock" %} and {% aTargetBlank
"https://developer.apple.com/documentation/swift/suspendingclock",
"SuspendingClock" %}.
