...
iOS 17 added the [inspector](<https://developer.apple.com/documentation/swiftui/view/inspector(ispresented:content:)>) view modifier.
...
<img alt="SwiftUI inspector closed" style="width: 49%"
  src="/blog/assets/SwiftUI-inspector-closed.png"
  title="SwiftUI inspector closed">
<img alt="SwiftUI inspector open" style="width: 49%"
  src="/blog/assets/SwiftUI-inspector-open.png"
  title="SwiftUI inspector closed">
