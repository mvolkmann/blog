...
- `arrowKey`
  ...
  This is generated when any arrow key is pressed.
  The parameter gives direction as "left", "right", "up", or "down".

- `closeCard`
- `controlKey`

  This is generated when the control key is pressed
...
- `doMenu`
  ...
  This is generated when a menu item is selected,
...
- `idle`
  ...
  This is generated every tick (1/60th of a second)
...
- `returnKey`
  ...
  This is generated when the return key is pressed.
...
- `commandKeyDown`
  ...
  This is generated when the command key is pressed
  in conjunction with another key.
...
- `help`: generated by selecting Go ... Help or pressing cmd-?
