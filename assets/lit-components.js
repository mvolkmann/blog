...
const Ye = n => {
    ...
    throw new Error(
      `Value passed to 'css' function must be a 'css' function result: ${n}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`
    );
  },
  Ge = n => new Ve(typeof n == 'string' ? n : String(n), void 0, pe),
  ue = (n, ...e) => {
    const t =
      n.length === 1 ? n[0] : e.reduce((i, s, r) => i + Ye(s) + n[r + 1], n[0]);
    return new Ve(t, n, pe);
  },
  Qe = (n, e) => {
    if (he)
  ...
  $e = he || Je ? n => n : n => (n instanceof CSSStyleSheet ? Ke(n) : n);
/**
 * @license
 ...
 */ const {
  ...
  _ = globalThis;
let b;
const Se = _.trustedTypes,
  it = Se ? Se.emptyScript : '',
  H = _.reactiveElementPolyfillSupportDevMode;
var Re;
{
  const n = _.litIssuedWarnings ?? (_.litIssuedWarnings = new Set());
  (b = (e, t) => {
    (t += ` See https://lit.dev/msg/${e} for more information.`),
      n.has(t) || (console.warn(t), n.add(t));
  }),
    b('dev-mode', 'Lit is in dev mode. Not recommended for production!'),
    (Re = _.ShadyDOM) != null &&
      Re.inUse &&
      H === void 0 &&
      b(
...
const ee = n => {
    _.emitLitDebugLogEvents &&
      _.dispatchEvent(new CustomEvent('lit-debug', {detail: n}));
  },
  E = (n, e) => n,
  B = {
    toAttribute(n, e) {
  ...
  fe = (n, e) => !Xe(n, e),
  ve = {attribute: !0, type: String, converter: B, reflect: !1, hasChanged: fe};
...
class w extends HTMLElement {
  ...
  static createProperty(e, t = ve) {
    if (
      ...
      const i = Symbol.for(`${String(e)} (@property() cache)`),
        s = this.getPropertyDescriptor(e, i, t);
      s !== void 0 && et(this.prototype, e, s);
    }
  }
  static getPropertyDescriptor(e, t, i) {
    const {get: s, set: r} = Pe(this.prototype, e) ?? {
      get() {
        return this[t];
      },
      set(o) {
    ...
    if (s == null) {
      if ('value' in (Pe(this.prototype, e) ?? {}))
        throw new Error(
          `Field ${JSON.stringify(String(e))} on ${
            this.name
          } was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`
        );
      b(
        'reactive-property-without-getter',
        `Field ${JSON.stringify(String(e))} on ${
          this.name
        } was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`
      );
    }
    return {
      get() {
  ...
  static finalize() {
    ...
    (this.elementStyles = this.finalizeStyles(this.styles)),
      ...
      this.hasOwnProperty('getPropertyDescriptor') &&
        b(
  ...
  __initialize() {
    ...
    (this.__updatePromise = new Promise(t => (this.enableUpdating = t))),
      ...
      this.requestUpdate(),
      (e = this.constructor._initializers) == null || e.forEach(t => t(this));
  }
  addController(e) {
    var t;
    (this.__controllers ?? (this.__controllers = new Set())).add(e),
  ...
  __propertyToAttribute(e, t) {
    ...
    const s = this.constructor.elementProperties.get(e),
      r = this.constructor.__attributeNameForProperty(e, s);
  ...
  _$attributeToProperty(e, t) {
    ...
    const i = this.constructor,
      s = i.__attributeToPropertyMap.get(e);
      ...
      const o = i.getPropertyOptions(s),
        l =
          typeof o.converter == 'function'
            ...
            : ((r = o.converter) == null ? void 0 : r.fromAttribute) !== void 0
            ? o.converter
            : B;
      (this.__reflectingProperty = s),
        (this[s] = l.fromAttribute(t, o.type)),
        (this.__reflectingProperty = null);
    }
  }
  requestUpdate(e, t, i) {
    if (e !== void 0) {
      ...
      const s = i.hasChanged ?? fe,
        r = this[e];
      if (s(r, t)) this._$changeProperty(e, t, i);
      else return;
    }
    this.isUpdatePending === !1 &&
  ...
  _$changeProperty(e, t, i) {
    this._$changedProperties.has(e) || this._$changedProperties.set(e, t),
      i.reflect === !0 &&
        this.__reflectingProperty !== e &&
        (
          this.__reflectingProperties ??
          (this.__reflectingProperties = new Set())
        ).add(e);
  }
  ...
  performUpdate() {
    ...
    if ((ee == null || ee({kind: 'update'}), !this.hasUpdated)) {
      this.renderRoot ?? (this.renderRoot = this.createRenderRoot());
      {
        const o = [...this.constructor.elementProperties.keys()].filter(
          l => this.hasOwnProperty(l) && l in we(this)
        );
        if (o.length)
          throw new Error(
            `The following properties on element ${
              this.localName
            } will not trigger updates as expected because they are set using class fields: ${o.join(
              ', '
      ...
      if (this.__instanceProperties) {
        for (const [r, o] of this.__instanceProperties) this[r] = o;
        this.__instanceProperties = void 0;
      }
      ...
      if (s.size > 0)
        for (const [r, o] of s)
          o.wrapped === !0 &&
            !this._$changedProperties.has(r) &&
            this[r] !== void 0 &&
            this._$changeProperty(r, this[r], o);
    }
    let e = !1;
  ...
  update(e) {
    this.__reflectingProperties &&
      (this.__reflectingProperties = this.__reflectingProperties.forEach(t =>
        this.__propertyToAttribute(t, this[t])
      )),
      this.__markUpdated();
  }
  updated(e) {}
...
w[E('elementProperties')] = new Map();
w[E('finalized')] = new Map();
H == null || H({ReactiveElement: w});
{
  w.enabledWarnings = ['change-in-update', 'async-perform-update'];
  const n = function (e) {
    e.hasOwnProperty(E('enabledWarnings')) ||
...
_.reactiveElementVersions.length > 1 &&
  b(
    'multiple-versions',
 ...
 */ const m = globalThis,
  d = n => {
    m.emitLitDebugLogEvents &&
      m.dispatchEvent(new CustomEvent('lit-debug', {detail: n}));
  };
let nt = 0,
  k;
m.litIssuedWarnings ?? (m.litIssuedWarnings = new Set()),
  (k = (n, e) => {
    (e += n ? ` See https://lit.dev/msg/${n} for more information.` : ''),
      m.litIssuedWarnings.has(e) ||
        (console.warn(e), m.litIssuedWarnings.add(e));
  }),
...
const y =
    (Me = m.ShadyDOM) != null &&
    Me.inUse &&
    ((ke = m.ShadyDOM) == null ? void 0 : ke.noPatch) === !0
      ? m.ShadyDOM.wrap
      : n => n,
  Z = m.trustedTypes,
  Ce = Z ? Z.createPolicy('lit-html', {createHTML: n => n}) : void 0,
  rt = n => n,
  Q = (n, e, t) => rt,
  ot = n => {
    if (T !== Q)
  ...
  ae = (n, e, t) => T(n, e, t),
  ze = '$lit$',
  P = `lit$${String(Math.random()).slice(9)}$`,
  De = '?' + P,
  lt = `<${De}>`,
  C = document,
  U = () => C.createComment(''),
  V = n => n === null || (typeof n != 'object' && typeof n != 'function'),
  Le = Array.isArray,
  dt = n =>
    Le(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == 'function',
  te = `[ 	
\f\r]`,
  ct = `[^ 	
\f\r"'\`<>=]`,
  ...
  ie = /'/g,
  ne = /"/g,
  Ie = /^(?:script|style|textarea|title)$/i,
  mt = 1,
  le = 2,
  me = 1,
  J = 2,
...
This is probably caused by illegal octal escape sequences.`),
      t.some(i => (i == null ? void 0 : i._$litStatic$)) &&
        k(
          '',
          `Static values 'literal' or 'unsafeStatic' cannot be used as values to non-static templates.
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`
        ),
      {_$litType$: n, strings: e, values: t}
    ),
  O = $t(mt),
  x = Symbol.for('lit-noChange'),
  u = Symbol.for('lit-nothing'),
  Ae = new WeakMap(),
  v = C.createTreeWalker(C, 129);
let T = Q;
function We(n, e) {
...
const Pt = (n, e) => {
  ...
  for (let a = 0; a < t; a++) {
    ...
    for (; f < c.length && ((o.lastIndex = f), (p = o.exec(c)), p !== null); )
      if (((f = o.lastIndex), o === M)) {
        if (p[Te] === '!--') o = Ee;
        else if (p[Te] !== void 0) o = xe;
        else if (p[se] !== void 0)
          Ie.test(p[se]) && (r = new RegExp(`</${p[se]}`, 'g')), (o = S);
        else if (p[pt] !== void 0)
          throw new Error(
        ...
        o === S
          ? p[ut] === '>'
            ...
            : p[Ne] === void 0
            ? (g = -2)
            : ((g = o.lastIndex - p[ft].length),
              (h = p[Ne]),
              (o = p[Oe] === void 0 ? S : p[Oe] === '"' ? ne : ie))
          : o === ne || o === ie
          ? (o = S)
          : o === Ee || o === xe
          ? (o = M)
    ...
    const W = o === S && n[a + 1].startsWith('/>') ? ' ' : '';
    s +=
      o === M
        ? c + lt
        : g >= 0
        ? (i.push(h), c.slice(0, g) + ze + c.slice(g) + P + W)
        : c + P + (g === -2 ? a : W);
  }
  const l = s + (n[t] || '<?>') + (e === le ? '</svg>' : '');
  return [We(n, l), i];
};
class z {
          ...
          for (const h of s.getAttributeNames())
            if (h.endsWith(ze)) {
              ...
              a.push({
                ...
                strings: W,
                ctor:
                  j[1] === '.' ? St : j[1] === '?' ? vt : j[1] === '@' ? Ct : K
              }),
                s.removeAttribute(h);
            } else
              h.startsWith(P) &&
                (a.push({type: _e, index: r}), s.removeAttribute(h));
        if (Ie.test(s.tagName)) {
          const h = s.textContent.split(P),
            f = h.length - 1;
          if (f > 0) {
            s.textContent = Z ? Z.emptyScript : '';
            for (let p = 0; p < f; p++)
              s.append(h[p], U()), v.nextNode(), a.push({type: J, index: ++r});
            s.append(h[f], U());
          }
        }
      } else if (s.nodeType === 8)
        if (s.data === De) a.push({type: J, index: r});
        else {
          let f = -1;
          for (; (f = s.data.indexOf(P, f + 1)) !== -1; )
            a.push({type: bt, index: r}), (f += P.length - 1);
        }
      r++;
    }
    if (g.length !== o)
...
function N(n, e, t = n, i) {
  ...
  let s =
    i !== void 0
      ? (o = t.__directives) == null
        ? void 0
        : o[i]
      : t.__directive;
  const r = V(e) ? void 0 : e._$litDirective$;
  return (
    (s == null ? void 0 : s.constructor) !== r &&
      ((l = s == null ? void 0 : s._$notifyDirectiveConnectionChanged) ==
        null || l.call(s, !1),
      r === void 0 ? (s = void 0) : ((s = new r(n)), s._$initialize(n, t, i)),
      i !== void 0
        ? ((t.__directives ?? (t.__directives = []))[i] = s)
        : (t.__directive = s)),
    s !== void 0 && (e = N(n, s._$resolve(n, e.values), s, i)),
    e
  );
}
class wt {
  ...
  _clone(e) {
    const {
      ...
      s = ((e == null ? void 0 : e.creationScope) ?? C).importNode(t, !0);
    v.currentNode = s;
    let r = v.nextNode(),
      o = 0,
      l = 0,
    ...
    for (; a !== void 0; ) {
      if (o === a.index) {
        let c;
        a.type === J
          ? (c = new I(r, r.nextSibling, this, e))
          : a.type === me
          ? (c = new a.ctor(r, a.name, a.strings, this, e))
          : a.type === _e && (c = new Tt(r, this, e)),
          this._$parts.push(c),
          (a = i[++l]);
      }
      o !== (a == null ? void 0 : a.index) && ((r = v.nextNode()), o++);
    }
    return (v.currentNode = C), s;
  }
  _update(e) {
    let t = 0;
    for (const i of this._$parts)
      i !== void 0 &&
        ...
        i.strings !== void 0
          ? (i._$setValue(e, i, t), (t += i.strings.length - 2))
          : i._$setValue(e[t])),
        t++;
  }
}
class I {
  get _$isConnected() {
    var e;
    return (
      ((e = this._$parent) == null ? void 0 : e._$isConnected) ??
      this.__isConnected
    );
  }
  constructor(e, t, i, s) {
    (this.type = J),
      (this._$committedValue = u),
      (this._$disconnectableChildren = void 0),
      (this._$startNode = e),
      (this._$endNode = t),
      (this._$parent = i),
      (this.options = s),
      (this.__isConnected = (s == null ? void 0 : s.isConnected) ?? !0),
    ...
    if (((e = N(this, e, t)), V(e)))
      e === u || e == null || e === ''
        ? (this._$committedValue !== u &&
            ...
            this._$clear()),
          (this._$committedValue = u))
        : e !== this._$committedValue && e !== x && this._commitText(e);
  ...
  _commitNode(e) {
    ...
    if (this._$committedValue !== e) {
      if ((this._$clear(), T !== Q)) {
        const i =
          (t = this._$startNode.parentNode) == null ? void 0 : t.nodeName;
        if (i === 'STYLE' || i === 'SCRIPT') {
          let s = 'Forbidden';
          throw (
            (i === 'STYLE'
  ...
  _commitText(e) {
    if (this._$committedValue !== u && V(this._$committedValue)) {
      ...
      this._textSanitizer === void 0 &&
        (this._textSanitizer = ae(t, 'data', 'property')),
        (e = this._textSanitizer(e)),
        d && d({kind: 'commit text', node: t, value: e, options: this.options}),
        (t.data = e);
    } else {
    ...
    const {values: t, ['_$litType$']: i} = e,
      s =
        typeof i == 'number'
          ...
          : (i.el === void 0 &&
              (i.el = z.createElement(We(i.h, i.h[0]), this.options)),
            i);
    if (((r = this._$committedValue) == null ? void 0 : r._$template) === s)
      d &&
        d({
      ...
      const o = new wt(s, this),
        l = o._clone(this.options);
      d &&
        d({
  ...
  _commitIterable(e) {
    ...
    for (const r of e)
      i === t.length
        ...
        i++;
    i < t.length &&
      (this._$clear(s && y(s._$endNode).nextSibling, i), (t.length = i));
  }
  _$clear(e = y(this._$startNode).nextSibling, t) {
    var i;
    for (
      (i = this._$notifyConnectionChanged) == null || i.call(this, !1, !0, t);
      e && e !== this._$endNode;
  ...
  setConnected(e) {
    ...
    if (this._$parent === void 0)
      (this.__isConnected = e),
        (t = this._$notifyConnectionChanged) == null || t.call(this, e);
    else
      throw new Error(
...
class K {
  ...
  _$setValue(e, t = this, i, s) {
    ...
    if (r === void 0)
      (e = N(this, e, t, 0)),
        (o = !V(e) || (e !== this._$committedValue && e !== x)),
        o && (this._$committedValue = e);
    else {
      const l = e;
      e = r[0];
      let a, c;
      for (a = 0; a < r.length - 1; a++)
        (c = N(this, l[i + a], t, a)),
          c === x && (c = this._$committedValue[a]),
          o || (o = !V(c) || c !== this._$committedValue[a]),
          c === u ? (e = u) : e !== u && (e += (c ?? '') + r[a + 1]),
          (this._$committedValue[a] = c);
    }
    o && !s && this._commitValue(e);
  }
  _commitValue(e) {
    e === u
      ? y(this.element).removeAttribute(this.name)
      : (this._sanitizer === void 0 &&
          (this._sanitizer = T(this.element, this.name, 'attribute')),
        (e = this._sanitizer(e ?? '')),
        d &&
          d({
...
class St extends K {
  ...
  _commitValue(e) {
    this._sanitizer === void 0 &&
      (this._sanitizer = T(this.element, this.name, 'property')),
      (e = this._sanitizer(e)),
      d &&
        d({
...
class Ct extends K {
  constructor(e, t, i, s, r) {
    if ((super(e, t, i, s, r), (this.type = yt), this.strings !== void 0))
      throw new Error(
        `A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`
      );
  }
  _$setValue(e, t = this) {
    if (((e = N(this, e, t, 0) ?? u), e === x)) return;
...
const re = m.litHtmlPolyfillSupportDevMode;
re == null || re(z, I);
(m.litHtmlVersions ?? (m.litHtmlVersions = [])).push('3.1.2');
m.litHtmlVersions.length > 1 &&
  k(
    'multiple-versions',
    'Multiple versions of Lit loaded. Loading multiple versions is not recommended.'
  );
const q = (n, e, t) => {
  ...
  const i = nt++,
    s = (t == null ? void 0 : t.renderBefore) ?? e;
  let r = s._$litPart$;
  if (
    (d &&
      d({
    ...
    s._$litPart$ = r = new I(e.insertBefore(U(), o), o, void 0, t ?? {});
  }
  return (
    r._$setValue(n),
    d &&
...
(q.setSanitizer = ot),
  (q.createSanitizer = ae),
  (q._testOnlyClearSanitizerFactoryDoNotCallOrElse = at);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
class $ extends w {
  ...
  update(e) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(e),
      (this.__childPart = q(t, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var e;
    super.connectedCallback(),
      (e = this.__childPart) == null || e.setConnected(!0);
  }
  disconnectedCallback() {
    var e;
    super.disconnectedCallback(),
      (e = this.__childPart) == null || e.setConnected(!1);
  }
  render() {
    return x;
  }
...
$[Et('finalized')] = !0;
var Ue;
(Ue = globalThis.litElementHydrateSupport) == null ||
  Ue.call(globalThis, {LitElement: $});
const oe = globalThis.litElementPolyfillSupportDevMode;
...
const xt = (n, e, t) => {
    ...
    return (
      e.constructor.createProperty(t, i ? {...n, wrapped: !0} : n),
      i ? Object.getOwnPropertyDescriptor(e, t) : void 0
    );
  },
  Nt = {attribute: !0, type: String, converter: B, reflect: !1, hasChanged: fe},
  Ot = (n = Nt, e, t) => {
    const {kind: i, metadata: s} = t;
    s == null &&
      Fe(
        'missing-class-metadata',
        `The class ${e} is missing decorator metadata. This could mean that you're using a compiler that supports decorators but doesn't support decorator metadata, such as TypeScript 5.1. Please update your compiler.`
      );
    let r = globalThis.litPropertyMetadata.get(s);
    if (
      (r === void 0 && globalThis.litPropertyMetadata.set(s, (r = new Map())),
      r.set(t.name, n),
      i === 'accessor')
    ) {
      const {name: o} = t;
      return {
        ...
        init(l) {
          return l !== void 0 && this._$changeProperty(o, void 0, n), l;
        }
      };
    } else if (i === 'setter') {
      const {name: o} = t;
...
function R(n) {
  return (e, t) => (typeof t == 'object' ? Ot(n, e, t) : xt(n, e, t));
}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ function At(n) {
  return R({...n, state: !0, attribute: !1});
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */ function qe(n) {
  return (e, t) => {
    const {slot: i, selector: s} = n ?? {},
      r = `slot${i ? `[name=${i}]` : ':not([name])'}`;
    return He(e, t, {
      get() {
        var a;
        const o = (a = this.renderRoot) == null ? void 0 : a.querySelector(r),
          l = (o == null ? void 0 : o.assignedElements(n)) ?? [];
...
var kt = Object.defineProperty,
  ...
  Vt = (n, e, t, i) => {
    for (
      var s = i > 1 ? void 0 : i ? Ut(e, t) : e, r = n.length - 1, o;
      r >= 0;
      r--
    )
      (o = n[r]) && (s = (i ? o(e, t, s) : o(s)) || s);
    return i && s && kt(e, t, s), s;
  };
function zt() {
...
let de = class extends $ {
  ...
  render() {
    return O`
      ...
      <button @click=${zt}>Click Me</button>
    `;
  }
};
de.styles = ue`
  ...
  `;
de = Vt([A('alert-on-click')], de);
var Dt = Object.defineProperty,
  Lt = Object.getOwnPropertyDescriptor,
  Be = (n, e, t, i) => {
    for (
      var s = i > 1 ? void 0 : i ? Lt(e, t) : e, r = n.length - 1, o;
      r >= 0;
      r--
    )
      (o = n[r]) && (s = (i ? o(e, t, s) : o(s)) || s);
...
let Y = class extends $ {
  ...
  render() {
    ...
    return O`<div>Hello, ${this.name}!</div>`;
  }
};
Y.styles = ue`
    :host {
  ...
  `;
Be([R()], Y.prototype, 'name', 2);
Y = Be([A('greet-message')], Y);
var It = Object.defineProperty,
  Wt = Object.getOwnPropertyDescriptor,
  Ze = (n, e, t, i) => {
    for (
      var s = i > 1 ? void 0 : i ? Wt(e, t) : e, r = n.length - 1, o;
      r >= 0;
      r--
    )
      (o = n[r]) && (s = (i ? o(e, t, s) : o(s)) || s);
...
let ce = class extends $ {
  constructor() {
    super(), (this.text = ''), console.log('constructor entered');
  }
  changeText() {
    this.text = 'changed';
  }
  attributeChangedCallback(n, e, t) {
    console.log(`${n} changed from ${e} to ${t}`),
      super.attributeChangedCallback(n, e, t);
  }
  connectedCallback() {
    super.connectedCallback(), console.log('connectedCallback entered');
  }
  disconnectedCallback() {
    super.disconnectedCallback(), console.log('disconnectedCallback entered');
  }
  render() {
    return O`
      <div>
...
Ze([R()], ce.prototype, 'text', 2);
ce = Ze([A('lifecycle-demo')], ce);
const jt =
...
var Ht = Object.defineProperty,
  ...
  ge = (n, e, t, i) => {
    for (
      var s = i > 1 ? void 0 : i ? qt(e, t) : e, r = n.length - 1, o;
      r >= 0;
      r--
    )
      (o = n[r]) && (s = (i ? o(e, t, s) : o(s)) || s);
...
D.styles = ue`
  ...
  `;
ge([R()], D.prototype, 'docsHint', 2);
ge([R({type: Number})], D.prototype, 'count', 2);
D = ge([A('my-element')], D);
var Bt = Object.defineProperty,
  Zt = Object.getOwnPropertyDescriptor,
  ye = (n, e, t, i) => {
    for (
      var s = i > 1 ? void 0 : i ? Zt(e, t) : e, r = n.length - 1, o;
      r >= 0;
      r--
    )
      (o = n[r]) && (s = (i ? o(e, t, s) : o(s)) || s);
...
let G = class extends $ {
  firstUpdated(n) {
    ...
    for (const e of this.defaultElements) e.style.color = 'red';
    for (const e of this.breakfastElements) e.style.color = 'green';
  }
  render() {
    return O`
      <div>
...
ye([qe({slot: 'breakfast'})], G.prototype, 'breakfastElements', 2);
ye([qe()], G.prototype, 'defaultElements', 2);
G = ye([A('slots-demo')], G);
var Jt = Object.defineProperty,
  Yt = Object.getOwnPropertyDescriptor,
  X = (n, e, t, i) => {
    for (
      var s = i > 1 ? void 0 : i ? Yt(e, t) : e, r = n.length - 1, o;
      r >= 0;
      r--
    )
      (o = n[r]) && (s = (i ? o(e, t, s) : o(s)) || s);
...
let L = class extends $ {
  ...
  changeP() {
    ...
    for (const n of this.buttons) {
      const e = n;
      e.style.color = this.p === 'go' ? 'green' : 'red';
    }
  }
  changeS() {
    this.s = 'changed';
...
X([R()], L.prototype, 'p', 2);
X([At()], L.prototype, 's', 2);
X([Mt('button')], L.prototype, 'buttons', 2);
L = X([A('state-changes')], L);
