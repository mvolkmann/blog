...
class Wrec extends HTMLElement {
  ...
  #d() {
    ...
    for (const [t, r] of Object.entries(s)) this.#y(t, r, e);
  }
  #y(t, e, s) {
  ...
  #b(t) {
    ...
    for (const t of e) this.#x(t), t.firstElementChild || this.#S(t);
  }
  ...
  #N(t, e) {
    ...
    return void 0 === this[s] && this.#P(t, '', s), s;
  }
  #A(t) {
  ...
  #w(t, e, s = void 0) {
    ...
    const n = this.#T(t);
    s ? updateValue(e, s, n) : this.#_(e, n);
  }
  #h(t, e) {
  ...
  #_(t, e) {
    ...
    'string' !== o &&
      ...
      'textarea' === r
        ...
        ? ((t.innerHTML = e), this.#E(t), this.#b(t))
        : s && (t.textContent = e);
  }
  useState(t, e) {
    this.#c = t;
...
export class State {
  ...
  addListener(t, e = []) {
    const s = new Set(e);
    this.#F.push({listener: t, propertySet: s});
  }
  addProperty(t, e) {
    Object.defineProperty(this, t, {
      enumerable: !0,
  ...
  #O(t, e, s) {
    for (const {listener: r, propertySet: o} of this.#F)
      (o && !o.has(t)) || r.changed(t, e, s);
  }
  removeListener(t) {
    this.#F = this.#F.filter(e => e.listener !== t);
  }
}
