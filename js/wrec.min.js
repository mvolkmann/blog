...
class Wrec extends HTMLElement {
  ...
  #T(t, e, s) {
    ...
    e.required &&
      !this.hasAttribute(r) &&
      this.#y(this, t, 'is a required attribute');
    ...
    (this[a] = n),
      ...
      Object.defineProperty(this, t, {
        ...
        set(s) {
          ...
          const i = this[a];
          if (s === i) return;
          this.#C(t, o, s), (this[a] = s);
          const {state: n, stateProp: p} = this.#s.properties[t];
          p && (n[p] = s),
            this.#M(t),
            this.#P(t, o, s, r),
            this.#A(t),
  ...
  disconnectedCallback() {
    this.#r.clear(), this.#a.clear(), this.#p.clear();
  }
  #N(t) {
    this.dispatchEvent(
  ...
  #w(t) {
    ...
    for (const s of t.getAttributeNames()) {
      ...
      if (o) {
        ...
        e && t.#a.set(Wrec.getPropName(i), o);
      }
      this.#$(r, t, s);
    }
  }
  ...
  #E(t) {
    ...
    for (const t of e) this.#w(t), t.firstElementChild || this.#I(t);
  }
  ...
  #S(t, e) {
    ...
    return void 0 === this[s] && this.#_(t, '', s), s;
  }
  #A(t) {
  ...
  #$(t, e, s = void 0) {
    ...
    const n = this.#b(t);
    s ? updateValue(e, s, n) : this.#F(e, n);
  }
  #l(t, e) {
  ...
  #_(t, e, s) {
    this.#y(t, e, `refers to missing property "${s}"`);
  }
  #R(t, e) {
    ...
    return r === String
      ...
      ? 'true' === e ||
        ('false' !== e &&
          ...
          e === t))
      : void this.#y(null, t, 'does not specify its type');
  }
  #P(t, e, s, r) {
    if (isPrimitive(s) && this.hasAttribute(r)) {
      s !== (e === Boolean ? this.hasAttribute(r) : this.#R(t, r)) &&
  ...
  #M(t) {
    ...
    for (const [t, s] of e) this[t] = this.#b(s);
  }
  #F(t, e) {
    ...
    'string' !== o &&
      'number' !== o &&
      this.#y(t, void 0, ' computed content is not a string or number'),
      'textarea' === r
        ? (t.value = e)
  ...
  useState(t, e) {
    for (const [s, r] of Object.entries(e)) {
      ...
      const o = t[s];
      void 0 !== o && (this[r] = o);
      const i = this.#s.properties[r];
      (i.state = t), (i.stateProp = s);
    }
    ...
    for (const t of this.getAttributeNames())
      'id' !== t &&
        (t.startsWith('on') ||
          ...
          this.#y(null, t, 'is not a supported attribute'));
  }
  #O(t, e, s) {
  ...
  #C(t, e, s) {
    ...
    if ('object' === r) {
      ...
      (r = o.name),
        o !== e &&
          this.#y(null, t, `was set to a ${r}, but must be a ${e.name}`);
    }
...
export class State {
  ...
  addListener(t, e = []) {
    const s = new Set(e);
    this.#H.push({listener: t, propertySet: s});
  }
  addProperty(t, e) {
    Object.defineProperty(this, t, {
      enumerable: !0,
  ...
  #k(t, e, s) {
    for (const {listener: r, propertySet: o} of this.#H)
      (o && !o.has(t)) || r.changed(this.#W, t, e, s);
  }
  removeListener(t) {
    this.#H = this.#H.filter(e => e.listener !== t);
  }
}
