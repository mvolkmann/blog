...
class Wrec extends HTMLElement {
  ...
  #h() {
    ...
    for (const [t, o] of Object.entries(s)) this.#g(t, o, e);
  }
  #g(t, e, s) {
    const o = Wrec.getAttrName(t);
    e.required &&
      !this.hasAttribute(o) &&
      this.#T(this, t, 'is a required attribute');
    ...
    (this[a] = n),
      ...
      Object.defineProperty(this, t, {
        ...
        set(s) {
          ...
          if (s === i) return;
          this[a] = s;
          const n = this.#s.propToComputedMap.get(t) || [];
          for (const [t, e] of n) this[t] = this.#E(e);
          if (isPrimitive(s) && this.hasAttribute(o)) {
            s !== (r === Boolean ? this.hasAttribute(o) : this.#b(t, o)) &&
  ...
  #x(t) {
    ...
    if ('style' === e) {
      ...
      if (s) {
        const o = this.#M(t, s);
        'textarea' === e && o
          ? (this.#p(t, o, null, 'change'), (t.textContent = this[o]))
          : this.#N(s, t);
      }
    }
  }
  ...
  #f(t) {
    ...
    for (const t of e) this.#A(t), t.firstElementChild || this.#x(t);
  }
  ...
  #M(t, e) {
    ...
    return void 0 === this[s] && this.#C(t, '', s), s;
  }
  #v(t) {
  ...
  #C(t, e, s) {
    this.#T(t, e, `refers to missing property "${s}"`);
  }
  #b(t, e) {
    ...
    return o === String
      ...
      ? 'true' === e ||
        ('false' !== e &&
          ...
          e === t))
      : void this.#T(null, t, 'does not specify its type');
  }
  #y(t) {
    const e = this[t],
      s = this.#n.get(t) || [];
  ...
  #w(t, e) {
    ...
    'string' !== r &&
      'number' !== r &&
      this.#T(t, void 0, ' computed content is not a string or number'),
      'textarea' === o
        ? (t.value = e)
        : s && 'string' === r && e.trim().startsWith('<')
        ? ((t.innerHTML = e), this.#m(t), this.#f(t))
        : s && (t.textContent = e);
  }
  #u() {
    const t = this.#s,
    ...
    for (const t of this.getAttributeNames())
      'id' !== t &&
        (t.startsWith('on') ||
          ...
          this.#T(null, t, 'is not a supported attribute'));
  }
  #P(t, e, s) {
