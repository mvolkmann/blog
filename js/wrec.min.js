...
class Wrec extends HTMLElement {
  ...
  connectedCallback() {
    this.#l(),
      ...
      requestAnimationFrame(() => {
        this.shadowRoot && (this.#m(this.shadowRoot), this.#f(this.shadowRoot));
        (this.#s.processed = !0), this.#d();
      });
  }
  #d() {
    const t = this.#s,
  ...
  #u() {
    ...
    for (const [t, o] of Object.entries(s)) this.#b(t, o, e);
  }
  #b(t, e, s) {
      ...
      Object.defineProperty(this, t, {
        ...
        set(s) {
          ...
          if (isPrimitive(s) && this.hasAttribute(o)) {
            s !== (r === Boolean ? this.hasAttribute(o) : this.#R(t, o)) &&
  ...
  #C(t) {
    ...
    for (const s of t.getAttributeNames()) {
      ...
      if (r) {
        const o = this[r];
        void 0 === o && this.#M(t, s, r), (t[r] = o);
        let [i, n] = s.split(':');
        'value' === i &&
          (n ? t.setAttribute(i, this[r]) : (n = 'change'),
          this.#c(t, r, i, n)),
  ...
  #w(t) {
    ...
    if ('style' === e) {
      ...
      const o = this.#T(t, s);
      'textarea' === e && o
        ? (this.#c(t, o, null, 'change'), (t.textContent = this[o]))
        : this.#N(s, t);
    }
  }
  ...
  #f(t) {
    ...
    for (const t of e) this.#C(t), t.firstElementChild || this.#w(t);
  }
  ...
  #T(t, e) {
    ...
    return void 0 === this[s] && this.#M(t, '', s), s;
  }
  #v(t) {
  ...
  #N(t, e, s = void 0) {
    ...
    const n = this.#E(t);
    s ? updateValue(e, s, n) : this.#y(e, n);
  }
  #p(t, e) {
  ...
  #P(t, e, s) {
    const o = s.match(REFERENCES_RE);
    if (o)
      return (
        o.forEach(s => {
          const o = s.substring(SKIP);
          void 0 === this[o] && this.#M(t, e, o);
        }),
        o
      );
  }
