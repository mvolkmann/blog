...
class Wrec extends HTMLElement {
  ...
  #l() {
    ...
    for (const [t, o] of Object.entries(s)) this.#E(t, o, e);
  }
  #E(t, e, s) {
    ...
    (this[a] = n),
      ...
      Object.defineProperty(this, t, {
        ...
        set(s) {
          ...
          for (const [t, e] of n) this[t] = this.#b(e);
    ...
    return o === String
      ...
      ? 'true' === e ||
        ('false' !== e &&
          ...
          e === t))
      : void this.#g(null, t, 'does not specify its type');
  }
  #x(t) {
    const e = this[t],
      s = this.#n.get(t) || [];
